export { CommentaireComponent } from './commentaire.component';
export { CommentaireModule } from './commentaire.module';
export { CommentaireDetailsComponent } from './details/commentaire-details.component';
