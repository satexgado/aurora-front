...
@Component({
  ...
  templateUrl: 'fichier-item-card-ui.component.html'
})

export class FichierItemCardUiComponent implements OnInit {
 ...
 onSendCommentaire() {
  ...
  unlockFirst(){
    this.notificationService.onInfo('Fichier verrouiller')
  }
}
