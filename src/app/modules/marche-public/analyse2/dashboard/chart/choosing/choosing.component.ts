...
export class ChoosingComponent implements OnInit {
  ...
  qualiteSelect = [
    ...
    {id: QualiteEnum.procedure, libelle: 'Procedure'},
  ...
  valeurSelect = [
    ...
    {id: ValeurEnum.nbfournisseur, libelle: 'Nombre de fournisseurs'},
    {id: ValeurEnum.nbmarche, libelle: 'Nombre de marches'},
    {id: ValeurEnum.nbpartenaire, libelle: 'Nombre de partenaires'},
  ];
  ...
  createForm() {
    this.configForm = this.formbuilder.group({
      valeur: new FormControl(ValeurEnum.nbmarche,Validators.required),
